...
namespace Qwerty.DAL.Migrations
{
    public partial class moveidentitytocore : Migration
    {
        ...
        {
            migrationBuilder.AddColumn<string>(name: "NormalizedName", table: "AspNetRoles", nullable: false, maxLength: 256);
            migrationBuilder.AddColumn<string>(name: "ConcurrencyStamp", table: "AspNetRoles", nullable: true);

            migrationBuilder.AddColumn<string>(name: "NormalizedName", table: "AspNetUsers", nullable: false, maxLength: 256);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendshipRequests", x => new { x.SenderUserId, x.RecipientUserId });
                    table.ForeignKey(
                        name: "FK_FriendshipRequests_Users_RecipientUserId",
                        column: x => x.RecipientUserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FriendshipRequests_Users_SenderUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAndTimeMessage = table.Column<DateTime>(nullable: false),
                    IdSender = table.Column<string>(nullable: true),
                    IdRecipient = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Messages", x => x.IdMessage);
                    table.ForeignKey(
                        name: "FK_Messages_Users_IdRecipient",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutUrl = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FriendshipRequests_RecipientUserId",
